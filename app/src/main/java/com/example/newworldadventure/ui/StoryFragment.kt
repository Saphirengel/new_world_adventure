...
class StoryFragment: Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.tvWeiter.text = "Hier gehts weiter"
     ...
     */
    private fun showTextWithDelay(textView: TextView, text: String, delay: Int, callback: () -> Unit) {
        val charArray = text.toCharArray()
        val stringBuilder = StringBuilder()
        var story = false
        textView.text = ""
        showNextChar(0, charArray, stringBuilder, textView, delay, callback)
    ...
    private fun showNextChar(index: Int, charArray: CharArray, stringBuilder: StringBuilder, textView: TextView, delay: Int, callback: () -> Unit) {
